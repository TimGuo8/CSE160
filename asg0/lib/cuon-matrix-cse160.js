 ...
 */
 ...
 class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var productArray =[other1.elements[1]*other2.elements[2]-other1.elements[2]*other2.elements[1],
        ...
        let v3 = new Vector3(productArray); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
