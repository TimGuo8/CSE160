function renderBodyParts(){
    ...
    if(g_Animation === true){
        head.matrix.rotate(10*Math.sin(2*g_seconds), 1, 0, 0);
        pause = g_seconds;
    }else{
...
//     horn.color=[84/255, 54/255, 8/255,1];
//     horn.matrix = mouthCoordinatesMat;
//     var hornCoordinateMat = new Matrix4(horn.matrix);
//     horn.matrix.translate(-0.02,0,-.3);
//     horn.matrix.rotate(g_horn, 1,0,0);
//     horn.matrix.scale(1,1,0.5);
//     horn.render();

//     //left eye
//     var l_eye = new Cube();
//     l_eye.color=[84/255, 54/255, 8/255,1];
//     l_eye.matrix=hornCoordinateMat;
...
//    // l_ear.matrix.rotate(g_horn, 1,0,0);
...
//     //r_ear.matrix.rotate(g_ear, 1,0,0);
...
//     if(shiftKey === true){
//         tail.matrix.rotate(10*Math.cos(4*g_seconds),0,0,1);
//     }
//     var tailCoordinateMat = new Matrix4(tail.matrix);
...
//     tail_hair.matrix = tailCoordinateMat;
